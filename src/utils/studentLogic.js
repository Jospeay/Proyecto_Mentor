 ...
 */
export function calculateNeededGrade(rubrics = [], targetGrade = 100) {
...
export function calculateAbsenceStatus(currentAbsences = 0, maxAllowedAbsences = 5) {
  ...
  let badgeStyle = 'border-glass-border text-text-muted';
  ...
  if (current >= maxAllowed) {
    ...
    riskLevel = 'warning';
    badgeStyle = 'border-amber-500/50 text-amber-400 bg-amber-500/10';
  } else if (current > 0) {
    riskLevel = 'normal';
    badgeStyle = 'border-glass-border text-text-primary';
  }
